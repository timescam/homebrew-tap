...
| `koharu` | `0.47.7` | ML-powered manga translator.<br />https://github.com/mayocream/koharu                                                                             |
| `motrix-next` | `3.8.0` | Modern Tauri-based download manager for macOS.<br />https://github.com/AnInsomniacy/motrix-next                                                  |
