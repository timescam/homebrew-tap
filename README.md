...
| `koharu` | `0.44.5` | ML-powered manga translator.<br />https://github.com/mayocream/koharu                                                                             |
| `motrix-next` | `3.6.10` | Modern Tauri-based download manager for macOS.<br />https://github.com/AnInsomniacy/motrix-next                                                  |
