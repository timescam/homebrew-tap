class Zagi < Formula
  ...
  on_arm do
    url "https://github.com/mattzcarey/zagi/releases/download/v0.1.7/zagi-macos-aarch64.tar.gz"
    sha256 "a38e24624d4970cc038df861715e212c4e4fc18339b7b909c29257a4ebaa81d8"
  end

  on_intel do
    url "https://github.com/mattzcarey/zagi/releases/download/v0.1.7/zagi-macos-x86_64.tar.gz"
